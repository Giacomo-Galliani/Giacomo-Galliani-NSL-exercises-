...
double Random :: Taylor(void){
   //this function generates a random number in [0, 1), distributed according to the f2 function  (accept-reject method)
...
double Random :: Sin(void){ //this function generates a random number in [0, 1) distributed according to the sin function (accept-reject method)
