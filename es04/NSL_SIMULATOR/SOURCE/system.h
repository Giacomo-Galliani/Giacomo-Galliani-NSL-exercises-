...
public: // Function declarations
  ...
  int get_ndim();             // Get the number of dimensions of the system
  double get_halfside(int);   // Get the i-th element of halfside. 
  double get_temp();          // Get the temperature of the system. 
  ...
  void write_pofv(int nconf); // Write system instanteneous pofv as an istrogram on the fly
  void read_configuration();  // Read system configuration from file
  void read_configuration_half_fcc(); //Read system fcc configuration from file 
  void read_configuration_velocities(); //Read system velocities from file 
  ...
  double getparticlevelocity (int, int); //Gets the velocity of a particle along a given direction
  void invert_velocities();   // Inverts the system velocities
  void new_measure();         // Reset global averages 
};
