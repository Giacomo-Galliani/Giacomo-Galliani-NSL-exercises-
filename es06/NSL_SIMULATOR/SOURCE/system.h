...
public: // Function declarations
  ...
  int get_npart();            //Get number of particles
  int get_ndim();             //Get dimension of the system 
  double get_halfside(int);   //Gets halfside of the box
  double get_temp();          //Get temperature of the system 
  ...
  void read_configuration_fcc(); //Read system fcc configuration from file
  void read_configuration_half_fcc(); //Read system half fcc configuration from file 
  void read_configuration_velocities(); //Read from file particle velocities 
  ...
  void set_temp(double);       //Set temperature of the system 
  void save_T_results(int);    //Saves to file results at a given temperature 
  void new_measurement();     //empties the_measurements accumulators
